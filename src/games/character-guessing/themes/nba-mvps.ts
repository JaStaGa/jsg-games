...
export const nbaMvpsGame: PlayableCharacterGame<NbaMvpSeason> = {
  ...
  candidatePicker: {
    searchText: (candidate) => [candidate.playerName, candidate.season, String(candidate.seasonStartYear), candidate.season.slice(2)],
    label: (candidate) => candidate.playerName,
    detail: (candidate) => candidate.season,
  },
  title: "NBA MVPs",
  ...
  uiCopy: {
    ...
    inputPlaceholder: "Search player or season",
